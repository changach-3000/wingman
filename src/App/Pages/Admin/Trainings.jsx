...
function Trainings() {
  return (
    <section class="bg-grey-50 h-screen">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold  dark:text-blacl">Learn more about poultry</h2>
            <p class="text-black sm:text-xl">Wakurugenziiiii!!,Want to learn more about poultry farming? worry not...you know why, bacuse we've got you! We offer you great support and resources to help you as you embark on your poultry rearing journey</p>
        </div>
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
               ...
               <a href='https://www.britannica.com/topic/poultry-farming/Types-of-poultry' target="_blank" > <h3 class="mb-2 text-xl font-bold dark:text-black">Poultry Farming</h3></a>
                <p class="text-black">This page will provide you with everything you need from all the types of chicken, to rearing cycles, to everything you need to know in the rearing of chicken</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <a href="https://www.kuku.co.ke/post/kienyeji-indigenous-chicken-vaccination-guide">  <h3 class="mb-2 text-xl font-bold dark:text-black">Vaccinations</h3></a>
                <p class="text-black">Get to see the vaccinations you need, when you need to give them and how they help your chicken to flourish.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
               ...
               <a href="https://www.standardmedia.co.ke/farmkenya/article/2001341797/how-to-control-common-diseases-and-pests-that-affect-poultry"> <h3 class="mb-2 text-xl font-bold dark:text-black">Diseases, Pest and Solutions</h3></a>
                <p class="text-black">Learn about the possible pests and diseases that might affect your poultry, and how to deal with them.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
               ...
               <a href='https://www.infonet-biovision.org/AnimalHealth/Chicken' target='blank'><h3 class="mb-2 text-xl font-bold dark:text-black">Breeding and Reproduction</h3></a>
                <p class="text-black ">Learn about poultry breeding and reproduction  and how to go about it.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
               ...
               <Link to="https://www.nationalchickencouncil.org/"> <h3 class="mb-2 text-xl font-bold dark:text-black">Economic and Business Aspects</h3></Link>
                <p class="text-black ">Learn how you can manage your finances as you start rearing poultry, from purchases to selling and investing.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
               ...
               <a href='https://ecochickspoultry.com/kari-improved-kienyeji-chicks-for-sale/' target='blank'><h3 class="mb-2 text-xl font-bold dark:text-black">Marketplace</h3></a>
                <p class="text-black">Here you get to learn about the poultry marketplace, and see how you can take your products to the market..</p>
            </div>
        </div>
    </div>
  </section>
